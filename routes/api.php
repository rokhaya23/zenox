...
//    return $request->user();
//});
Route::middleware(['auth:sanctum',\App\Http\Middleware\SecureMiddlewere::class])->group( function(){
...
// Routes pour les réponses
    ...
    Route::post('/add-reponses', [AnswerController::class, 'store']);
...
// Routes pour les thèmes
    ...
    Route::post('/validate', [\App\Http\Controllers\ValidatedAnswerController::class, 'validateAnswer']);

    Route::post('/logout', [AuthController::class, 'logout']);
    Route::get('/refresh', [AuthController::class,'refresh'])->name('refresh');
});

Route::post('/register', [AuthController::class,'register'])->withoutMiddleware([\App\Http\Middleware\SecureMiddlewere::class]);
Route::post('/login', [AuthController::class,'login'])->withoutMiddleware([\App\Http\Middleware\SecureMiddlewere::class]);
